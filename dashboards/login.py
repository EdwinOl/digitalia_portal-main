...
def serve_layout():
    index_login = html.Div([
        ...
        dbc.Row([
            dbc.Col([dbc.Form([
                dbc.Input(type="email", id="login-username", placeholder="Enter email", className="login-username-input"), dbc.Input(type="password", id="login-password",
                                                                                                                                     placeholder="Enter password", className="login-password-input"), html.Button("Login", id="btn-login"), dcc.Loading(dbc.Row(id="login-result"), type="circle")
            ]), dbc.Row(html.Button("Reset or Sign up", id="btn-login-reset")), dbc.Row(id='login-reset')
            ]),
    ...
    def login_reset(n_clicks):
        ...
        if n_clicks//2 != n_clicks/2:
            ...
            return html.P(id="text-login-reset",
                          ...
                          style={"width": "60%", "text-align": "center", "margin-left": "auto",
